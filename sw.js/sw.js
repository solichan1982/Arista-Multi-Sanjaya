...
;var Ha = function(a, b, c) {
  ...
  , Ka = function(a, {m: b, o: c, info: d, u: e, j: f, length: g, salt: k}) {
    return h(function*() {
        const m = yield Ha(a, ya({
            o: c,
            m: b,
            j: f
        }), k);
        return yield Ia(a, m, za({
            u: e,
            info: d,
            j: f,
            length: g
...
function lb(a, b) {
    ...
    if ((c = b.crypto) == null ? 0 : c.subtle) {
        ...
        try {
            const d = kb(a);
            return b.crypto.subtle.digest("SHA-256", d).then(e => mb(e, b)).catch( () => "e2")
        } catch (d) {
...
var pb = function(a, b) {
  ...
  , sb = function(a, b) {
    return () => {
        b.fallback_url && b.fallback_url_method && qb(a, {
...
var wb = function(a, b, c) {
    return h(function*() {
        ...
        const e = d
          , f = new ab(e,a.g.btoa);
        return vb(a, a.g.performance.now(), (e == null ? void 0 : e.id) || "undefined", f.encrypt(b))
    })
}
  , xb = function(a, b, c) {
    return h(function*() {
        return vb(a, a.g.performance.now(), "unknown", eb(c.encryptionKeyString || "").encryptMessage(b).then(d => ({
  ...
  , vb = function(a, b, c, d) {
    ...
    , () => [`ec.${bb(15)}`, "&_es=15"].join("")).catch( () => [`ec.${bb(16)}`, "&_es=16"].join(""))
}
  , Db = class {
    constructor(a) {
        this.g = a;
